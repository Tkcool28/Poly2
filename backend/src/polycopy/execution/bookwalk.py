...
class FillResult:
    ...
    depth_consumed: Decimal  # total shares available on our side
    levels_consumed: int
...
def walk_book(
    ...
    *,
    ...
    for lv in levels:
        if remaining_usd <= 0:
            break
        # Shares we can take at this level: limited by level depth and by
        # how much notional we still want to spend.
