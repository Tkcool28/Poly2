...
is the safe, non-terminal verdict — the wallet is rescored automatically
as the tail deepens). Never describe a score as covering the wallet's
complete trading history unless a backfill feature has shipped.
